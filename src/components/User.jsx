...
const User = () => {
  ...
  const getVideos = async () => {
    const videos = await queryUser(node, user);
    setVideos(videos);
    return videos;
  };
